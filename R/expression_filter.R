...
expression_filter = function(stats, clusters, min.significant = 1, min.target.pct = 0.3, max.background.pct = 0.7, min.diff.pct = 0.2, min.de.frac = 0.01, min.significance.level = NULL, plot = TRUE) {
  ## evaluate arguments
